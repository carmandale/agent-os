...
for hook in "stop-hook.sh" "post-tool-use-hook.sh" "user-prompt-submit-hook.sh" "pre-bash-hook.sh" "post-bash-hook.sh" "notify-hook.sh" "workflow-enforcement-hook.py"; do
