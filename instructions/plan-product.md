...
**Quick Start:** Run `./dev.sh` to start both services
...
wait
      ...
      <make_executable>chmod +x dev.sh</make_executable>
    </create_dev_sh>
  </if_web_project>
</startup_script_creation>
...
<environment_file_creation>
  <frontend_env_local>
    <condition>if frontend detected</condition>
...
PROJECT_NAME=[PROJECT_NAME]
  ...
  <backend_env>
    <condition>if backend detected</condition>
